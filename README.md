...
|:---:|
| Full-stack AI platform · Automated mock interviews · ML-powered feedback via NLP · Performance tracking dashboard · Behavioral analytics with MongoDB · Real-time evaluation |
| **Stack**: `Python` · `FastAPI` · `React` · `Transformers` · `MongoDB Atlas` · `Firebase` · `PostgreSQL` |
| [![Live Demo](https://img.shields.io/badge/▶%20LIVE%20DEMO-PREPWISE-6d28d9?style=for-the-badge&logo=vercel&logoColor=white)](#) &nbsp; [![Source Code](https://img.shields.io/badge/💻%20SOURCE%20CODE-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/UtsavRaj1111/PrepWise-AI-Driven-Interview-Practice-and-Career-Growth-Platform) |
